...
#if defined(NDEBUG)
#error "satoshishift cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ushft) are considered zero fee (for relaying and mining)
...
{
    RenameThread("satoshishift-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // SHFT: We use certain sporks during IBD, so check to see if they are
