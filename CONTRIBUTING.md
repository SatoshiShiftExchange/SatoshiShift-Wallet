Contributing to Satoshishift Core
==================================

The Satoshishift Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Satoshishift Core project, and is not to be
confused with overall Satoshishift Network Protocol consensus changes.

Whether a pull request is merged into Satoshishift Core rests with the project merge
...
Patches that change Satoshishift consensus rules are considerably more involved than
...
Where a patch set proposes to change the Satoshishift consensus, it must have been
...
The project leader is the release manager for each Satoshishift Core release.
