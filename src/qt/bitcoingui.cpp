                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Satoshishift") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SHFT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Satoshishift: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Satoshishift"), this);
    aboutAction->setStatusTip(tr("Show information about Satoshishift"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Satoshishift"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SHFT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SHFT addresses"));
    ...
    openAction->setStatusTip(tr("Open a Satoshishift: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Satoshishift help message to get a list with possible Satoshishift command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Satoshishift client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Satoshishift network", "", count));
}
...
{
    QString strTitle = tr("Satoshishift"); // default title
