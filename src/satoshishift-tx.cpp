...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Satoshishift Core satoshishift-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  satoshishift-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded satoshishift transaction") + "\n" +
                               "  satoshishift-tx [options] -create [commands]   " + _("Create hex-encoded satoshishift transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded satoshishift transaction
