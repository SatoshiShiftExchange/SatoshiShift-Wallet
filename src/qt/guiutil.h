...
/** Utility functions used by the Satoshishift Qt UI.
 */
namespace GUIUtil
{
...
// Render SHFT addresses in monospace font
...
// Parse "satoshishift:" URI into recipient object, return true on successful parsing
