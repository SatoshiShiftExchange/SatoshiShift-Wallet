...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Satoshishift"),
     ...
     * override -datadir in the satoshishift.conf file in the default data directory
     * (to be consistent with satoshishiftd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
