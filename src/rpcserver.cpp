...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop satoshishift server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "satoshishift server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* satoshishift features */
        {"satoshishift", "masternode", &masternode, true, true, false},
        {"satoshishift", "listmasternodes", &listmasternodes, true, true, false},
        {"satoshishift", "getmasternodecount", &getmasternodecount, true, true, false},
        {"satoshishift", "masternodeconnect", &masternodeconnect, true, true, false},
        {"satoshishift", "masternodecurrent", &masternodecurrent, true, true, false},
        {"satoshishift", "masternodedebug", &masternodedebug, true, true, false},
        {"satoshishift", "startmasternode", &startmasternode, true, true, false},
        {"satoshishift", "createmasternodekey", &createmasternodekey, true, true, false},
        {"satoshishift", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"satoshishift", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"satoshishift", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"satoshishift", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"satoshishift", "getmasternodescores", &getmasternodescores, true, true, false},
        {"satoshishift", "mnbudget", &mnbudget, true, true, false},
        {"satoshishift", "preparebudget", &preparebudget, true, true, false},
        {"satoshishift", "submitbudget", &submitbudget, true, true, false},
        {"satoshishift", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"satoshishift", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"satoshishift", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"satoshishift", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"satoshishift", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"satoshishift", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"satoshishift", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"satoshishift", "checkbudgets", &checkbudgets, true, true, false},
        {"satoshishift", "mnsync", &mnsync, true, true, false},
        {"satoshishift", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> satoshishift-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34219/\n";
}
