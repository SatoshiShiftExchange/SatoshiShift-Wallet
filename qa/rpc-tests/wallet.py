...
#   c) node1 mines 32 blocks, so now node 0 has 500000SHFT, node 1 has 4250SHFT, node2 has none.
#   d) node0 sends 601 SHFT to node2, in two transactions (301 SHFT, then 300 SHFT).
